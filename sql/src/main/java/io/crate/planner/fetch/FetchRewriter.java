...
public final class FetchRewriter {
    ...
    public final static class FetchDescription {
        ...
        private final Function<? super Field, ? extends Symbol> mapFieldsToPostFetchFunction;
        ...
        private FetchDescription(TableIdent tableIdent,
            ...
            mapFieldsToPostFetchFunction = f -> postFetchOutputs.get(f.index());
        }
        ...
        public boolean availablePreFetch(Symbol tree) {
            ...
            FieldsVisitor.visitFields(tree, f -> {
                Symbol symbol = mapFieldsToPostFetchFunction.apply(f);
        ...
        public Function<? super Symbol,? extends Symbol> mapFieldsInTreeToPostFetch() {
            return FieldReplacer.bind(mapFieldsToPostFetchFunction);
        }

        public Function<? super Field,? extends Symbol> replaceFieldsWithPostFetchSymbols() {
            return mapFieldsToPostFetchFunction;
        }
        ...
        public void updatePostFetchOutputs(List<Symbol> newOutputs) {
            List<Symbol> newPostFetchOutputs = Lists2.copyAndReplace(
                newOutputs,
                st -> FieldReplacer.replaceFields(st, mapFieldsToPostFetchFunction));
            postFetchOutputs.clear();
            postFetchOutputs.addAll(newPostFetchOutputs);
        }

        public Collection<? extends Symbol> postFetchOutputs() {
